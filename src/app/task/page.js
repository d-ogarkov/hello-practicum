...
export default function Task() {
  return (
    <>
      ...
      <Code children={code1}></Code>
      <p className={styles.text}>Или так:</p>
      <Code children={code2}></Code>
